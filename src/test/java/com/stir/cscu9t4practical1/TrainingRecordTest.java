...
public class TrainingRecordTest {
    ...
    public void testAddEntry() {
        ...
        AthleteRunRecord a = new AthleteRunRecord("Alice", 1, 2, 2003, 0, 16, 7, 3);
    ...
    public void testAddEntryUnique() {
        ...
        AthleteRunRecord a = new AthleteRunRecord("Alice", 1, 2, 2003, 0, 16, 7, 3);
        AthleteRunRecord b = new AthleteRunRecord("Alice", 1, 2, 2003, 0, 16, 7, 3);
        TrainingRecord instance = new TrainingRecord();
        instance.addEntry(a);
        instance.addEntry(b);
        assertEquals(instance.getNumberOfEntries(),1);
    ...
    public void testLookupEntry() {
        ...
        AthleteRunRecord a = new AthleteRunRecord("Alice", 1, 2, 2003, 0, 16, 7, 3);
        AthleteRunRecord b = new AthleteRunRecord("Bob", 1, 2, 2003, 0, 14, 15, 3);
        AthleteRunRecord c1 = new AthleteRunRecord("Claire", 7, 3, 2010, 0, 26, 20, 7);
        AthleteRunRecord c2 = new AthleteRunRecord("Claire", 11, 3, 2010, 0, 24, 55, 7);
        instance.addEntry(a);
        instance.addEntry(b);
