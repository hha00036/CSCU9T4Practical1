...
public class SwimEntryTest {
    ...
    public void testGetName() {
        ...
        AthleteRunRecord instance = new SwimmingAthlete("Alice", 1, 2, 2003, 0, 16, 7, 3,"outdoors");
    ...
    public void testGetDay() {
        ...
        AthleteRunRecord instance = new SwimmingAthlete("Alice", 1, 2, 2003, 0, 16, 7, 3,"pool");
        int expResult = 1;
    ...
    public void testGetWhere() {
        ...
        AthleteRunRecord instanceA = new SwimmingAthlete("Alice", 1, 2, 2003, 0, 16, 7, 3,"outdoors");
        String expResultA = "outdoors";
        String result = ((SwimmingAthlete) instanceA).getWhere();
        assertEquals(expResultA, result);
        
        AthleteRunRecord instanceB = new SwimmingAthlete("Alice", 1, 2, 2003, 0, 16, 7, 3,"pool");
        String expResultB = "in a pool";
        String result1 = ((SwimmingAthlete) instanceB).getWhere();
