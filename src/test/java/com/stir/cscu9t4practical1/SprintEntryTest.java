...
public class SprintEntryTest {
    ...
    public void testGetName() {
        ...
        AthleteRunRecord instance = new RunningAthlete("Alice", 1, 2, 2003, 0, 16, 7, 300, 4, 2);
    ...
    public void testGetRepetitions() {
        ...
        AthleteRunRecord instance = new RunningAthlete("Alice", 1, 2, 2003, 0, 16, 7, 300, 4, 2);
        int expResults = 4;
        int result = ((RunningAthlete) instance).getRepetitions();
    ...
    public void testGetRecovery() {
        ...
        AthleteRunRecord instance = new RunningAthlete("Alice", 1, 2, 2003, 0, 16, 7, 300, 4, 2);
        int expResults = 2;
        int result = ((RunningAthlete) instance).getRecovery();
        assertEquals(expResults, result);
    }
