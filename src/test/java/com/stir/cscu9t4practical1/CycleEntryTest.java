...
public class CycleEntryTest {
    ...
    public void testGetName() {
        ...
        AthleteRunRecord instance = new CyclingAthlete("Alice", 1, 2, 2003, 0, 16, 7, 3, "asphalt", "moderate");
    ...
    public void testGetDay() {
        ...
        AthleteRunRecord instance = new CyclingAthlete("Alice", 1, 2, 2003, 0, 16, 7, 3, "gravel", "moderate");
        int expResult = 1;
    ...
    public void testGetMonth() {
        ...
        AthleteRunRecord instance = new CyclingAthlete("Alice", 1, 2, 2003, 0, 16, 7, 3, "mountain", "fast");
        int expResult = 2;
    ...
    public void testGetYear() {
        ...
        AthleteRunRecord instance = new CyclingAthlete("Alice", 1, 2, 2003, 0, 16, 7, 3, "gravel", "slow");
        int expResult = 2003;
    ...
    public void testGetHour() {
        ...
        AthleteRunRecord instance = new CyclingAthlete("Alice", 1, 2, 2003, 0, 16, 7, 3, "asphalt", "fast");
        int expResult = 0;
    ...
    public void testGetTerrain() {
        ...
        String result = ((CyclingAthlete) instance).getTerrain();
        assertEquals(expResult, result);
    }
    ...
    public void testGetTempo() {
        ...
        String result = ((CyclingAthlete) instance).getTempo();
        assertEquals(expResult, result);
    }
